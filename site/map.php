...
<html lang="pt-BR">
	<head>
		...
		<script type="text/javascript">
			var path = "data/" + "<?php echo $_GET['year']; ?>" + "/";
		</script>
		...
		<!--Mapquest APIs-->
    <script src="http://open.mapquestapi.com/sdk/leaflet/v1.0/mq-map.js?key=Fmjtd%7Cluur25ub25%2C8s%3Do5-9w7x50"></script>
		...
		<div class="container">
			<div class="page-header">
				...
				<div id="button-wrapper" style="margin-top: -45px;  float: right;">
					<div class="btn-group">
						<a class="btn btn-primary" data-toggle="dropdown" href="#"><b>Baixar os dados por Órgão (em Planilha)</b></a>
